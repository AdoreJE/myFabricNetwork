...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client register --caname ca-sales1 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/sales1/tls-cert.pem
  set +x
  ...
  mkdir -p organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-sales1 -M ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/msp --csr.hosts peer1.sales1.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/sales1/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/msp/config.yaml

  echo
  echo "## Generate the peer1-tls certificates"
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-sales1 -M ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls --enrollment.profile tls --csr.hosts peer1.sales1.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/sales1/tls-cert.pem
  set +x


  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/ca.crt
  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/signcerts/* ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/server.crt
  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/keystore/* ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/server.key

  mkdir -p ${PWD}/organizations/peerOrganizations/sales1.example.com/msp/tlscacerts
  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales1.example.com/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/organizations/peerOrganizations/sales1.example.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales1.example.com/tlsca/tlsca.sales1.example.com-cert.pem

  mkdir -p ${PWD}/organizations/peerOrganizations/sales1.example.com/ca
  cp ${PWD}/organizations/peerOrganizations/sales1.example.com/peers/peer1.sales1.example.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/sales1.example.com/ca/ca.sales1.example.com-cert.pem
...
function createSales2 {

  echo
	echo "Enroll the CA admin"
  echo
	mkdir -p organizations/peerOrganizations/sales2.example.com/

	export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/sales2.example.com/
#  rm -rf $FABRIC_CA_CLIENT_HOME/fabric-ca-client-config.yaml
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:8054 --caname ca-sales2 --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-sales2.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-sales2.pem
    OrganizationalUnitIdentifier: peer
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-8054-ca-sales2.pem
    OrganizationalUnitIdentifier: orderer' > ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/config.yaml

  echo
	echo "Register peer0"
  echo
  set -x
	fabric-ca-client register --caname ca-sales2 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client register --caname ca-sales2 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client register --caname ca-sales2 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client register --caname ca-sales2 --id.name sales2admin --id.secret sales2adminpw --id.type admin --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x

	mkdir -p organizations/peerOrganizations/sales2.example.com/peers
  mkdir -p organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com
  mkdir -p organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com

  echo
  echo "## Generate the peer0 msp"
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-sales2 -M ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/msp --csr.hosts peer0.sales2.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/msp/config.yaml

  echo
  echo "## Generate the peer0-tls certificates"
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-sales2 -M ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls --enrollment.profile tls --csr.hosts peer0.sales2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x


  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/ca.crt
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/signcerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/server.crt
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/keystore/* ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/server.key

  mkdir -p ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/tlscacerts
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/organizations/peerOrganizations/sales2.example.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/tlsca/tlsca.sales2.example.com-cert.pem

  mkdir -p ${PWD}/organizations/peerOrganizations/sales2.example.com/ca
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer0.sales2.example.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/ca/ca.sales2.example.com-cert.pem

  echo
  echo "## Generate the peer1 msp"
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-sales2 -M ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/msp --csr.hosts peer1.sales2.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/msp/config.yaml

  echo
  echo "## Generate the peer1-tls certificates"
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-sales2 -M ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls --enrollment.profile tls --csr.hosts peer1.sales2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x


  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/ca.crt
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/signcerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/server.crt
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/keystore/* ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/server.key

  mkdir -p ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/tlscacerts
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/organizations/peerOrganizations/sales2.example.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/tlsca/tlsca.sales2.example.com-cert.pem

  mkdir -p ${PWD}/organizations/peerOrganizations/sales2.example.com/ca
  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/peers/peer1.sales2.example.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/sales2.example.com/ca/ca.sales2.example.com-cert.pem


  mkdir -p organizations/peerOrganizations/sales2.example.com/users
  mkdir -p organizations/peerOrganizations/sales2.example.com/users/User1@sales2.example.com

  echo
  echo "## Generate the user msp"
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:8054 --caname ca-sales2 -M ${PWD}/organizations/peerOrganizations/sales2.example.com/users/User1@sales2.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/sales2.example.com/users/User1@sales2.example.com/msp/config.yaml

  mkdir -p organizations/peerOrganizations/sales2.example.com/users/Admin@sales2.example.com

  echo
  echo "## Generate the org admin msp"
  echo
  set -x
	fabric-ca-client enroll -u https://sales2admin:sales2adminpw@localhost:8054 --caname ca-sales2 -M ${PWD}/organizations/peerOrganizations/sales2.example.com/users/Admin@sales2.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/sales2/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/sales2.example.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/sales2.example.com/users/Admin@sales2.example.com/msp/config.yaml
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9054 --caname ca-customer --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client register --caname ca-customer --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
  ...
  mkdir -p organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com

  echo
  echo "## Generate the peer0 msp"
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9054 --caname ca-customer -M ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer0.customer.example.com/msp --csr.hosts peer0.customer.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9054 --caname ca-customer -M ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer0.customer.example.com/tls --enrollment.profile tls --csr.hosts peer0.customer.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:9054 --caname ca-customer -M ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/msp --csr.hosts peer1.customer.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/customer.example.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/msp/config.yaml

  echo
  echo "## Generate the peer1-tls certificates"
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:9054 --caname ca-customer -M ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls --enrollment.profile tls --csr.hosts peer1.customer.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x

  cp ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/ca.crt
  cp ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/signcerts/* ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/server.crt
  cp ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/keystore/* ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/server.key

  mkdir -p ${PWD}/organizations/peerOrganizations/customer.example.com/msp/tlscacerts
  cp ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/customer.example.com/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/organizations/peerOrganizations/customer.example.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/customer.example.com/tlsca/tlsca.customer.example.com-cert.pem

  mkdir -p ${PWD}/organizations/peerOrganizations/customer.example.com/ca
  cp ${PWD}/organizations/peerOrganizations/customer.example.com/peers/peer1.customer.example.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/customer.example.com/ca/ca.customer.example.com-cert.pem
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:9054 --caname ca-customer -M ${PWD}/organizations/peerOrganizations/customer.example.com/users/User1@customer.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://customeradmin:customeradminpw@localhost:9054 --caname ca-customer -M ${PWD}/organizations/peerOrganizations/customer.example.com/users/Admin@customer.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
